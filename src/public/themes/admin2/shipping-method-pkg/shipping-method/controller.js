    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#shipping_methods_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_shipping_method').val(state_save_val.search.search);
                }
            ...
            scrollCollapse: true,
            ajax: {
                url: url(laravel_routes['getShippingMethodList']),
                type: "GET",
                dataType: "json",
                data: function(d) {
                    d.shipping_method_code = $('#shipping_method_code').val();
                    d.shipping_method_name = $('#shipping_method_name').val();
            ...
            columns: [
                ...
                { data: 'code', name: 'shipping_methods.code' },
                { data: 'name', name: 'shipping_methods.name' },
                { data: 'mobile_no', name: 'shipping_methods.mobile_no' },
                { data: 'email', name: 'shipping_methods.email' },
            ],
...
app.component('shippingMethodForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? shipping_method_get_form_data_url : shipping_method_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            shipping_method_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                shipping_method_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            shipping_method_get_city_by_state = vendor_get_city_by_state
            $http.post(
                shipping_method_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
